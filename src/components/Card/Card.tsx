            ...
            <div className="title">
                ...
                <div className="title__info">
                    <Popover width={200} position="bottom" withArrow shadow="md">
                        <Popover.Target>
                            <svg style={{ width: 20, height: 20 }} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-info-circle" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#9e9e9e" fill="none" strokeLinecap="round" strokeLinejoin="round">
