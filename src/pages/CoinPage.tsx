            ...
            <div className="content">
                ...
                <Paper shadow='lg'>
                    <Grid columns={16} gutter={0} >
                        {
                            coinCards.map(((item: ICard) => (
                                <Grid.Col key={item.title} span={16} sm={8} lg={4} xs={16}>
